...
import { getTemplateByType } from "../../config/product-templates";
...
export default function Create() {
  ...
  // Get template data based on URL param
  const template = useMemo(() => {
    return templateParam ? getTemplateByType(templateParam) : null;
  }, [templateParam]);
  ...
  const [price, setPrice] = useState(template?.suggestedPrice || "");
